...
namespace WebASPCorePremiereApp.Controllers
{
    public class AuteursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Prenom,Nom")] Auteur auteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Prenom,Nom")] Auteur auteur)
        {
            if (id != auteur.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> LierLivreAuteur(int id)
        {
